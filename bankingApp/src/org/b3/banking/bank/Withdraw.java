...
public class Withdraw extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user==null)
		{
			...
			request.setAttribute("msg","Amount not withdraw please try again latter");
		...
		{
		float withdraw=bal-Float.parseFloat(amt);
		user.setBal(withdraw+"");
		...
		request.setAttribute("msg","Amount Withdrawed");
		request.getRequestDispatcher("my_account.jsp").forward(request, response);
		}
		}
		}catch (Exception e) {
